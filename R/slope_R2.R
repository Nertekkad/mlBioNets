# Slope R^2
#'
#' Get the slope and R-squared of linear models of topologiclal properties*.
#' @usage slope_R2(df_properties)
#' @param df_properties A data.frame generated by ml_properties.
#' @returns Returns a data.frame describing the slope and the R-squared of linear models from data.frame generated by ml_properties.
#' @examples
#' slope_R2 (data.frame)
#'
